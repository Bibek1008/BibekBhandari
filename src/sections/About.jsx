      ...
      <div className="grid xl:grid-cols-3 xl:grid-rows-6 md:grid-cols-2 grid-cols-1 gap-5 h-full">
        <div className="col-span-1 xl:row-span-3">
          <div className="grid-container">
            ...
            <div>
              <p className="grid-headtext">Hi, I'm Bibek Bhandari</p>
              <p className="grid-subtext">
                Computer Science Engineering student (2022-2026) at CMR Institute of Technology, Bangalore. I'm a CS
                enthusiast focused on full-stack JavaScript and machine learning projects.
              </p>
              <button
        ...
        <div className="col-span-1 xl:row-span-3">
          <div className="grid-container">
            ...
            <div>
              ...
              <p className="grid-subtext">
                I work with JavaScript and the MERN stack: MongoDB, Express.js, React.js, and Node.js. I'm proficient
            ...
            <div className="rounded-3xl w-full sm:h-[326px] h-fit flex justify-center items-center bg-gray-800">
              ...
              <div className="flex flex-col items-center justify-center">
                <div className="w-40 h-40 rounded-full bg-gray-700 flex items-center justify-center overflow-hidden border-4 border-blue-500">
                  <img src="/assets/myphoto.jpg" alt="Bibek Bhandari" className="w-full h-full object-cover" />
                </div>
        ...
        <div className="xl:col-span-2 xl:row-span-3">
          <div className="grid-container">
            ...
            <div>
              ...
              <p className="grid-subtext">
                I'm passionate about building solutions through code. As a computer science student, I enjoy tackling
                algorithmic challenges and creating real-world applications. I'm constantly exploring emerging
            ...
            <div className="space-y-2">
              ...
              <div className="copy-container" onClick={handleCopy}>
                ...
                <p className="lg:text-2xl md:text-xl font-medium text-gray_gradient text-white">
                  bibekbhandari9848@gmail.com
                </p>
              </div>
              <div className="flex justify-center gap-4 mt-4">
                <a href="https://github.com/Bibek1008" target="_blank" rel="noopener noreferrer">
                  <img src="/assets/github.svg" alt="GitHub" className="w-6 h-6" />
                </a>
                <a
                  href="https://www.linkedin.com/in/bibek-bhandari-053283226/"
                  target="_blank"
                  rel="noopener noreferrer">
                  <img src="/assets/linkedin.svg" alt="LinkedIn" className="w-6 h-6" />
                </a>
                <a href="https://www.instagram.com/bibek.node" target="_blank" rel="noopener noreferrer">
